...
// void default_constants() {
//   // P, I, D, and Start I
//   chassis.pid_drive_constants_set(10, 0.0, 40.0);      // Fwd/rev constants, used for odom and non odom motions
//   chassis.pid_heading_constants_set(15.0, 0.0, 24.5);    // Holds the robot straight while going forward without odom
//   chassis.pid_turn_constants_set(2, 0.05, 22, 15.0);     // Turn in place constants
//   chassis.pid_swing_constants_set(6.0, 0.0, 65.0);       // Swing constants
//   chassis.pid_odom_angular_constants_set(3, 0, 70);  // Angular control for odom motions
//   chassis.pid_odom_boomerang_constants_set(3, 0, 70);  // Angular control for boomerang motions
...
void skillsWR() {
  ...
  chassis.pid_odom_set({{{-5.5_in, 13_in}, rev, 127}}, true);
  ...
  // pros::delay(550);
  chassis.pid_odom_set({{{-54_in, 41_in, -90_deg}, fwd, 127}}, true);
  tongue.set_value(1);
  pros::delay(1000);
  ...
  intake.move(127);
  chassis.pid_drive_set(21.5, 55, false);  // match load #1
  ...
  tongue.set_value(0);
  intake.move(0);
  chassis.pid_drive_set(-72, 127, true);
  pros::delay(1500);
  ...
  chassis.pid_odom_set({{{29_in, 50.6_in, 90_deg}, rev, 127}}, false); //first scoring
  ...
  // chassis.pid_odom_set({{{68_in, 51_in, 90_deg}, fwd, 127}}, true);
  ...
  chassis.pid_odom_set({{{29_in, 52.3_in, 90_deg}, rev, 127}}, true);  // second scoring
  pros::delay(1000);
  // chassis.pid_wait_quick_chain();
  ...
  chassis.pid_odom_set({
                           ...
                           {{70_in, 12_in, 173_deg}, fwd, 127},
                       },  // park
                       true);

  chassis.pid_wait_until_index(0);

  // chassis.odom_xy_set(68.2, 25);
  // chassis.drive_angle_set(178_deg);
  ...
  descore.set_value(1);
  pros::delay(200);
  chassis.pid_drive_set(44_in, 110, false);
  pros::delay(1500);
  chassis.pid_turn_set(175_deg, TURN_SPEED);
  ...
  // pros::delay(3700);    //old total delay
  
  // pros::delay(1850);

  // pros::delay(1900);    //go back to 1100
 
  // drive_until_distance(1000);
  ...
  //                          {{16.2_in, -15.5_in, 135_deg}, rev, 127},
  //                      },  // park
  //                      true);

  // chassis.pid_odom_set({{{16.2_in, -15.5_in, 135_deg}, rev, 127}}, true);
  chassis.pid_odom_set({{{16.2_in, -15.5_in}, rev, 127}}, true);
  pros::delay(2400);
  intake.move(-127);
  ...
  intake.move(0);
  pros::delay(200);
  chassis.pid_turn_set(131_deg, TURN_SPEED);
  pros::delay(100);
  ...
  chassis.pid_odom_set({{{60_in, -49_in, 90_deg}, fwd, 90}}, true);  // 3rd match load
  ...
  intake.move(127);
  chassis.pid_drive_set(19, 127, false);
  ...
  chassis.pid_odom_set({{{24_in, -68_in}, rev, 127}}, true);
  ...
  chassis.pid_drive_set(-68, 127, false);
  // chassis.pid_wait_quick_chain();
  pros::delay(1450);
  // chassis.pid_turn_set(-135_deg, TURN_SPEED);
  // pros::delay(450);
  ...
  chassis.pid_odom_set({{{-20_in, -57.2_in, -90_deg}, rev, 127}}, true); //3rd scoring
  ...
  tongue.set_value(1);
  chassis.pid_odom_set({{{-44_in, -55.5_in, -90_deg}, fwd, 127}}, true);      //last match load
  pros::delay(1100);
  descore.set_value(1);
  chassis.pid_turn_set(-90_deg, TURN_SPEED);
  pros::delay(150);
  ...
  chassis.pid_odom_set({{{-24_in, -51.5_in, -90_deg}, rev, 50}}, true);   //last long goal scoring
  ...
  chassis.pid_drive_set(56_in, 110, false);
...
void LeftControl() {
  ...
  chassis.pid_turn_set(-45_deg, TURN_SPEED);
  pros::delay(390);
  chassis.pid_odom_set({{{-58_in, 47.2_in, -66_deg}, fwd, 127}}, false);

  pros::delay(1400);
  chassis.pid_turn_set(270_deg, TURN_SPEED);
  pros::delay(200);
  chassis.pid_drive_set(17_in, 45, false);
...
void RightTroy() {
  ...
  tongue.set_value(1);
  pros::delay(250);
  chassis.pid_odom_set({{{-7_in, -52.5_in, 155_deg}, fwd, 127}}, true);
  pros::delay(250);
  tongue.set_value(0);
  pros::delay(1550);
  ...
  pros::delay(1200);
  tongue.set_value(1);
  chassis.pid_odom_set({{{-48_in, -45_in}, fwd, 127}}, true);  // match load
  ...
  chassis.pid_odom_set({{{-8_in, -17_in, 55_deg}, fwd, 127}}, true);  // mid goal
  intake1.move(127);
  intake3.move(-127);
  intake2.move(-127);
  ...
  descore.set_value(0);
  chassis.pid_odom_set({{{-29_in, -41_in}, rev, 127}}, true);  // push
  pros::delay(350);
...
void troy() {
  ...
  // tongue.set_value(1);
  // pros::delay(800);
  chassis.pid_odom_set({{{-24_in, 30.5_in}, rev, 127}}, true);
  pros::delay(1000);
  ...
  chassis.pid_swing_set(ez::RIGHT_SWING, -85, 127, 7);
  ...
  chassis.pid_odom_set({{{0.5_in, 5.5_in, -45_deg}, rev, 127}}, true);  // mid goal
  ...
  chassis.pid_drive_set(30, 127, true);
  chassis.pid_wait_until(26_in);
  chassis.pid_odom_set({{{-28_in, 38.7_in}, fwd, 127}}, true);  // push
  pros::delay(700);
...
void SoloSigWP() {
  ...
  chassis.pid_odom_set({{{-31_in, -45.5_in, -90_deg}, rev, 127}}, true);  // first long goal
  pros::delay(700);
  ...
  pros::delay(700);
  chassis.pid_odom_set({{{-24_in, 28_in, 0_deg}, fwd, 127}}, true);
  ...
  chassis.pid_odom_set({{{-13_in, 13.8_in}, rev, 127}}, false);
  // tongue.set_value(1);
  pros::delay(450);
  chassis.pid_turn_set(-55_deg, TURN_SPEED);
  intake.move(-127);
  ...
  pros::delay(700);
  intake.move(127);
  chassis.pid_odom_set({{{-63_in, 51_in, -90_deg}, fwd, 127}}, true);
  pros::delay(1000);
  chassis.pid_turn_set(-90_deg, TURN_SPEED);
  pros::delay(100);
  chassis.pid_drive_set(16, 50, false);
  pros::delay(1300);

  // chassis.pid_wait_until(4);
  // pros::delay(470);
  // chassis.pid_targets_reset();
  chassis.pid_odom_set({{{-30_in, 51_in, -90_deg}, rev, 127}}, true);
...
void control() {
  ...
  intake.move(127);
  descore.set_value(1);
  chassis.pid_odom_set({{{-12.5_in, -27.2_in, 125_deg}, fwd, 127}}, false);
  ...
  pros::delay(390);
  chassis.pid_odom_set({{{-55_in, -48_in, 246_deg}, fwd, 127}}, false);

  pros::delay(1400);
  chassis.pid_turn_set(270_deg, TURN_SPEED);
  pros::delay(200);
  chassis.pid_drive_set(15_in, 95, false);
  pros::delay(600);
  ...
  chassis.pid_odom_set({{{-21_in, -37_in}, rev, DRIVE_SPEED}}, false);
  pros::delay(700);
